...
# ****************************************************************
#
# files2011data = FileUtils.loadListFromFile ('datasets/CMS_Run2011A_SingleMu_AOD_12Oct2013-v1_10000_file_index.txt') and 
# replace 'CMS_Run2011A_SingleMu_AOD_12Oct2013-v1_10000_file_index.txt' with new file for different run. And for CMS_Run2012, all these files are stored in file "datasets/".
# *** DoubleMu data set ***
files2011data = FileUtils.loadListFromFile ('datasets/CMS_Run2012C_DoubleMuParked_AOD_22Jan2013-v1_10001_file_index.txt')
...
#      the file 'DoubleMu-2012.root' generated by 'src/DimuonSpectrum2011.cc' is used to sellect the dimuon informations, you can modify 'src/DimuonSpectrum2011.cc' according to your own requirements
       fileName = cms.string('DoubleMu-2012.root')
                                   )
